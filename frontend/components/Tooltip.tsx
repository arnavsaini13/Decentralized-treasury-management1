      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className={`absolute ${positionClasses[position]} z-50 px-3 py-2 text-xs font-medium text-white bg-slate-900 border border-slate-700 rounded-lg shadow-xl whitespace-nowrap pointer-events-none`}
          >
            {content}
